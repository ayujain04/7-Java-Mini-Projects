...
public class NBody {
	...
	public static CelestialBody[] readBodies(String fname) throws FileNotFoundException {
		...
		int nb = (int)s.nextDouble();          // # bodies to be read

		// TODO: Create array that can store nb CelestialBodies
		// TODO: read and ignore radius

		CelestialBody[] cbArr = new CelestialBody[nb];
		...
		for(int k=0; k < nb; k++) {
			...
			cbArr[k] = new CelestialBody(s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.next()); 
